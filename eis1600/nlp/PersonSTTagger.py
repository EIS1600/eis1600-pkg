...
@singleton
class PersonSTTagger:
    __model = None

    def __init__(self) -> None:
        model_path = PRETRAINED_MODELS_REPO + 'camelbert-ca-finetuned_person_classification_STN/'
        ...
        PersonSTTagger.__model = NERecognizer(model_path)

    @synchronized
    @staticmethod
    def predict(tokens: List[str]) -> List[str]:
        return PersonSTTagger.__model.predict(tokens)
