...
@singleton
class OnomasticTagger:
    __model = None

    def __init__(self) -> None:
        model_path = PRETRAINED_MODELS_REPO + 'camelbert-ca-finetuned_onomastic/'
        ...
        OnomasticTagger.__model = NERecognizer(model_path)

    @synchronized
    @staticmethod
    def predict(tokens: List[str]) -> List[str]:
        return OnomasticTagger.__model.predict(tokens)
