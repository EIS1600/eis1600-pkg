from eis1600.eis1600_tags import MIU_HEADER_PATTERN, NEWLINES_PATTERN
    ...
    with open(miu_file, 'r', encoding='utf-8') as file:
        ...
        for line in iter(file):
            if MIU_HEADER_PATTERN.match(line):
                # Omit the #MIU#Header# line as it is only needed inside the MUI.EIS1600 file, but not in YMLDATA.yml
                next(file)
                line = next(file)
